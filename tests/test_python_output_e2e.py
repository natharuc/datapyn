...
"""
        ...
        # Verificar que e PNG valido (magic bytes)
        assert figures[0][:8] == b'\x89PNG\r\n\x1a\n', "Nao e PNG valido"
...
class TestSessionWidgetFigureRouting:
    ...
    def test_figures_routed_to_results_panel(self, qapp):
        ...
        # Verificar que display_images foi chamado
        mock_results.display_images.assert_called_once_with([fake_png], "Grafico")
    ...
    def test_error_goes_to_output_not_results(self, qapp):
        ...
        mock_results.display_images.assert_not_called()
    ...
    def test_dataframe_goes_to_results_grid(self, qapp):
        ...
        # display_dataframe chamado (nao display_images)
    ...
    def test_figures_plus_dataframe(self, qapp):
        ...
        # display_images deve ser chamado (graficos tem prioridade visual)
        mock_results.display_images.assert_called_once()
        mock_main.show_panel.assert_called_with('results')
...
"""
        ...
        viewer = ResultsViewer()
        viewer.display_images(figures, "E2E Chart")
...
"""
        ...
        viewer = ResultsViewer()
        viewer.display_images(figures, "Top 10 Clientes")
...
"""
        ...
        viewer = ResultsViewer()
        viewer.display_images(figures, "Vendas")
        assert viewer.stack.currentIndex() == 1

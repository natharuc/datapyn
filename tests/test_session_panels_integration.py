...
class TestNewTabCleansState:
    ...
    def test_tab_switch_shows_correct_panel(self, main_window):
        ...
        assert main_window._output_stack.currentWidget() is main_window._session_panel_indices[s1_id]["output"]

        # Trocar para segunda sessao
        main_window._switch_session_panels(s2_id)
        assert main_window._output_stack.currentWidget() is main_window._session_panel_indices[s2_id]["output"]

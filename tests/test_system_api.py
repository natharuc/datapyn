...
class TestConnectionManagerAPI:
    ...
    def test_get_saved_connections_returns_list(self, connection_manager):
        ...
        connection_manager.save_connection_config(name="DB1", db_type="mssql", host="h1", port=1433, database="db1")
        connection_manager.save_connection_config(name="DB2", db_type="mssql", host="h2", port=1433, database="db2")
    ...
    def test_get_connection_config(self, connection_manager):
        ...
        connection_manager.save_connection_config(
            name="MyDB", db_type="mysql", host="myhost", port=3306, database="mydb", username="user"
        )
    ...
    def test_mark_connection_used(self, connection_manager):
        ...
        connection_manager.save_connection_config(name="UsedDB", db_type="mssql", host="h", port=1433, database="db")
...
class TestWorkspaceManagerAPI:
    ...
    def test_save_workspace(self, workspace_manager):
        ...
        tabs = [{"code": "SELECT 1", "connection": None, "title": "Script 1"}]
...
class TestPersistence:
    ...
    def test_connection_manager_persists(self, connection_manager, temp_dir):
        ...
        connection_manager.save_connection_config(
            name="PersistTest", db_type="mssql", host="localhost", port=1433, database="test"
        )
...
class TestEdgeCases:
    ...
    def test_special_chars_in_connection_name(self, connection_manager):
        ...
        connection_manager.save_connection_config(
            name="Test [Prod] - Server (1)", db_type="mssql", host="localhost", port=1433, database="test"
        )
...
class TestSystemIntegration:
    ...
    def test_full_workflow(self, connection_manager, workspace_manager, shortcut_manager):
        ...
        connection_manager.save_connection_config(
            name="DevDB", db_type="mssql", host="localhost", port=1433, database="devdb", group="Development"
        )

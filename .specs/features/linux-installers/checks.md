...
- **Boundary:** BUILD fix round 3 closes the full and AppImage-only missing/invalid version boundary gap at `92ec965`; all four new cases passed and the requested packaging suite passed (88 passed, 4 skipped). The Coverage join now maps Landing door 4 to C8, C9 and C19. C5, C6, and C22 remain pending their external actions.

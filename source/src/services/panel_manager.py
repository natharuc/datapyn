...
class PanelSet:
    ...
    __slots__ = ("results", "output", "variables", "results_idx", "output_idx", "variables_idx")

    def __init__(self, results, output, variables, results_idx: int, output_idx: int, variables_idx: int):

...
class ConnectionManager:
    ...
    def save_connection_config(self, name: str, db_type: str, host: str, 
                              port: int, database: str, username: str = '', 
                              save_password: bool = False, password: str = '',
                              group: str = '', use_windows_auth: bool = False,
                              color: str = ''):
    ...
    def update_connection_config(self, old_name: str, new_name: str, db_type: str, 
        ...
        if old_name in self.saved_configs.get('connections', {}):
            ...
            self.save_connection_config(new_name, db_type, host, port, database,
                                       username, save_password, password, group,
                                       use_windows_auth, color)
    ...
    def create_connection(self, name: str, db_type: str, host: str, port: int, 
                         database: str, username: str, password: str, **kwargs) -> DatabaseConnector:
